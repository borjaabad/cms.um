...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script language="javascript">
		function eliminarCliente(nombre, id){
			ventana=confirm("Esta seguro que desea eliminar al cliente '" + unescape(nombre)  + "' ?");
			 if (ventana) {	 
				location.href="<?php echo BASE_URL . "cliente/eliminar/";?>" + id ;
			 }      
		}
	</script>
