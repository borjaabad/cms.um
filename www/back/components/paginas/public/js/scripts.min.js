    ...
    b = b[0] + '/' +  b[1] + '/' +  b[2] + '/' +  b[3] + '/guardar';
      $.post(b,
            ...
            function(data, textStatus, jqXHR){
                if(data)
                    alertify.success("Se ha guardado correctamente la página!!!");
                else
                    alertify.success("Hubo un problema con la página!!!");
...
$(document).ready(function() {
    ...
    $.get( "../../../../paginas/maquetacion/getoriginal/" + id + "/", function( data ) {
       
        $( ".demo" ).html(data);
        
        inicializaEditor();
                
        alertify.success( "Se cargó correctamente su página!" );
      });
...
function inicializaEditor(){
    ...
    $("#fullscreen").click(function() {
        ...
        //  alert(clicked);
        if (clicked) {
            $("#wrapper", parent.document).css('padding-left', '');
            $("#sidebar-wrapper", parent.document).css('left', '');
            $(this).removeClass("active").css("background", "");
            clicked = false;
            exit;
        }
        else {
            $("#wrapper", parent.document).css('padding-left', '0');
            $("#sidebar-wrapper", parent.document).css('left', '0');
            $(this).addClass("active").css("background", "#D83526");
            clicked = true;
        }
