<div class="lyrow ui-draggable" style="display: block;">
                                    ...
                                    <div class="view">
                                        <div class="row clearfix">
                                            <div class="col-md-12 column ui-sortable"><div class="lyrow ui-draggable" style="display: block;">
                                    <a href="#close" class="remove label label-danger"><img class="dragimga" src="../../public/img/papelera.png">eliminar</a>
                                    <span class="drag label "><img class="dragimga" src="../../public/img/drag.png"></span>
                                    <div class="preview"><input type="text" value="12" class="form-control"></div>
                                    <div class="view">
                                    ...
                                    <div class="view">
                                        <h3 contenteditable="true">Tabla de contenidos</h3>
                                    </div>
                                    ...
                                    <div class="view">
                                        <div class="row clearfix">
                                            <div class="col-md-6 column ui-sortable"><div class="box box-element ui-draggable" style="display: block; position: relative; opacity: 1; z-index: 0;">
                                    <a href="#close" class="remove label label-danger"><img class="dragimga" src="../../public/img/papelera.png">eliminar</a>
                                    <span class="drag label label-default"><img class="dragimga" src="../../public/img/drag.png"></span>
                                    <span class="configuration">		  
                                    ...
                                    <div class="view">
                                        <ul contenteditable="true">
                                            <li>Introducción</li>
                                            <li>Relativización de los contenidos dinámicos</li>
                                            <li>Rendimiento: contenido dinámico VS contenido estático</li>
                                            <li>Caché bajo demanda</li>
                                            <li>Back y Front, dos aplicaciones</li>
                                            <li>Componentes</li>
                                            <li>Módulos<br></li>
                                            <li>Páginas</li>
                                        </ul>
