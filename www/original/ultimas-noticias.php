<div class="lyrow ui-draggable" style="display: block;">
                                    ...
                                    <div class="view">
                                        <div class="row clearfix">
                                            <div class="col-md-12 column ui-sortable"><div class="box box-element ui-draggable" style="display: block; position: relative; opacity: 1; z-index: 0;">
                                    ...
                                    <div class="view">
                                        <div class="page-header">
                                            <h1 contenteditable="true">Últimas noticias <font color="#999999"><span style="font-size: 23px; line-height: 23px;">actualizado cada minuto</span></font></h1>
                                        </div>
                                    </div>
                                </div></div>
                                        </div>
                                    ...
                                    <div class="view">
                                        <div class="row clearfix">
                                            <div class="col-md-4 column ui-sortable"><div class="lyrow ui-draggable" style="display: block;">
                                    <a href="#close" class="remove label label-danger"><i class="glyphicon-remove glyphicon"></i> remove</a>
                                    <span class="drag label label-default"><i class="glyphicon glyphicon-move"></i> drag</span>
                                    ...
                                    <div class="view">
                                        <div class="row clearfix">
                                            <div class="col-md-8 column ui-sortable"></div>
