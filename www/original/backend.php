<div class="lyrow ui-draggable" style="display: block;">
                                    ...
                                    <div class="preview">Título</div>
                                    <div class="view">
                                        <h3 contenteditable="true">Última hora</h3>
                                    </div>
                        ...
                        <div class="view">
                            [[noticias::index::ultimahora]]
                                    ...
                                    <div class="preview">Título</div>
                                    <div class="view">
                                        <h3 contenteditable="true">Listado firmantes</h3>
                                    </div>
                                </div><div class="box box-element ui-draggable" style="display: block; position: relative; opacity: 1; z-index: 0;">
                        <a href="#close" class="remove label label-danger"><img class="dragimga" src="../../public/img/papelera.png">eliminar</a>
                        <span class="drag label label-default"><img class="dragimga" src="../../public/img/drag.png"></span>
                        <div class="preview">Firmantes</div>
                        <div class="view">
                            [[noticias::firmantes::index]]
                        </div>
                    </div></div>
                                        </div>
                                    </div>
